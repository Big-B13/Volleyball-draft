...
// Mini bios for each player. Written based on nickname, playstyle, and stat profile.
export const PLAYER_BIOS = {
  p01: "The most natural athlete on the court who somehow made it here without ever playing volleyball seriously. Reads plays like a defender in another sport — because that's exactly what he is.",
  p02: "Doesn't jump the highest, doesn't hit the hardest — somehow still ends every rally on the scoreboard. Small frame, giant timing.",
  p03: "Named after the anime libero for a reason. Pancakes balls that should have hit the floor two seconds ago. Lives on the wood.",
  p04: "Terminator arm. Every swing is a full commit. When the set is good, it's not even fair — the ball crosses the net before the block gets there.",
  p05: "Every gym needs one. Full effort, huge heart, still figuring out where his hands go. Give him a year and this bio gets rewritten.",
  p06: "Named for the future because that's when the block realizes she already dug it. Reads angles like she has the game manual.",
  p07: "The complete package — hits, serves, digs, sets, moves. There is no weakness to attack. Coaches build offenses around him without needing to ask.",
  p08: "Left-side sniper. Rope-line swings that clip the antenna and drop inside the pin. The kind of hitter you set even from a bad pass.",
  p09: "The one no captain wants to leave for the next round. Nine out of nine. Every single skill. Every single rally. Just Nightmare.",
  p10: "Massive right arm, allergic to jumping. Sits down every attack. If you can convince him the floor is lava, he might just be top-three in the league.",
  p11: "Officially listed as libero, unofficially plays every position at once. Diving pass, running set, cover on the block. All in one rotation.",
  p12: "Steady as her name. Never panics, never over-swings, always in the right spot. The player every captain wishes they had two of.",
  p13: "You'll see the ceiling on his ceiling next season. Right now he's rated for what he does; ask again in six months.",
  p14: "The brain of any team he's on. Sets tempos other teams don't have plays for. Won't out-power you — will absolutely out-think you.",
  p15: "Wing on defense. Somehow always in front of the ball. The kind of pass that turns broken plays into first-tempo kills.",
  p16: "Elite. Hates the nickname his teammates gave him. Uses it as fuel. Every serve after being reminded of it lands in the corner.",
  p17: "Solid across every stat — the seven-out-of-ten specialist. No weakness to hunt, no highlight reel to fear. Just wins his rotation.",
  p18: "Quiet swings, quiet digs, quiet leadership. Never the loudest on court, always in the box score.",
  p19: "Explosive. Left-handed rockets from the right side. When the ball leaves his hand you don't hear it — you hear it hit the tape.",
  p20: "Every gym has a legend. Joran is that legend on this floor. Nines across the board. Not a stat to fix — a stat to fear.",
  p21: "New to the sport, bringing pure vibes. Great teammate. Will run through a wall for a pass. The wall might win — for now.",
  p22: "Point-blank rocket-propelled grenades. Fires from the pin, fires from the pipe, fires from where you didn't think you needed a blocker. Rockets everywhere.",
  p23: "Head high, chin up, brain always three moves ahead. Every touch has a purpose. Every purpose has a plan.",
  p24: "Long strides. Reads the block before jumping. Turns half-decent sets into clean kills through sheer body control.",
  p25: "First season energy. Every ball she touches surprises her — and everyone else. Bright future, current chapter still being written.",
  p26: "Hands like glass. Sets that arrive exactly where a hitter's swing was already going. Rarely spectacular, always exactly right.",
  p27: "Attack side, defense side, doesn't matter. Cleans up whatever the rally leaves behind. Nothing hits the floor near him without a fight.",
  p28: "Feet don't leave the ground; her mind never leaves the play. Always in the right spot, always making the correct next touch.",
  p29: "Big personality on a raw skill set. When it clicks, it clicks — the highlight is coming. Just needs the reps."
};
